...
def wtm_text_dialogue():
    ...
    submit_wtm_txt.grid(row=3, column=1)
...
def wtm_text():
    ...
    drawing.text((10, 10), text, fill='black', font=font)
    image_text.show()
...
upload_btn = Button(text='Upload', highlightthickness=0, command=upload_action)
